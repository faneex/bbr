...
function openimg(img)
{
	...
	if((foto1.width!=0)&&(foto1.height!=0)){
		...
		window.open(baseUrl + "Common/pop(viewimg).php?imgfile="+img,"",stringA);
	} else {
...
function viewImagePop(imgCtl){
	...
	img.onload = function(){
		...
		imgViewer.location.href="/cbt/common/ImageViewer.php?imgSRC="+escape(imgCtl.src);
	}
	img.src = imgCtl.src;
}
...
function viewImagePop2(imgSrc){
	...
	img.onload = function(){
		...
		var imgViewer = window.open("","imgViewer",param);
		imgViewer.location.href="/cbt/common/ImageViewer.php?imgSRC="+escape(this.src);
	}
	img.src = imgSrc;	
}
